    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="{{ route('transactions.update', $item->id)}}" method="post">
                ...
                <div class="form-group">
                    <label for="addres" class="form-control-label">Alamat Pemesan</label>
                    <input  type="text"
                            name="addres"
                            value="{{ old('addres') ? old('addres') : $item->addres }}"
                            class="form-control @error('addres') is-invalid @enderror"/>
                    @error('addres') <div class="text-muted">{{ $message }}</div> @enderror
                </div>
                <div class="form-group">
